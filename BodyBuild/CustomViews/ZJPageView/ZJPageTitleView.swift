...
extension ZJPageTitleView {
    ...
    private func setUpTitleLabel(){
        ...
        for (index,title) in titles.enumerated() {
            ...
            lab.font = option.kIsNormalFontBold ? OYUtils.BoldFontSize(option.kTitleFontSize) : OYUtils.FontSize(option.kTitleFontSize)
    ...
    private func setBottomMenuAndScrollLine(){
        ...
        if option.kTitleSelectFontSize != nil {
            firstLab.font = OYUtils.BoldFontSize(option.kTitleSelectFontSize!)
        }
...
extension ZJPageTitleView {
    ...
    private func setupLabelsLayout() {
        ...
        for (i, titleLabel) in titleLabs.enumerated() {
            ...
            titleLabel.frame = CGRect(x: labelX, y: labelY, width: labelW+OYUtils.Adapt(10), height: labelH)
        }
        if option.isTitleScrollEnable {
...
extension ZJPageTitleView {
    ...
    func setPageTitleWithProgress(progress: CGFloat,  sourceIndex: Int, targetIndex:Int) {
        ...
        if option.kTitleSelectFontSize != nil{
            sourceLab.font = option.kIsNormalFontBold ? OYUtils.BoldFontSize(option.kTitleSelectFontSize! - (option.kTitleSelectFontSize! - option.kTitleFontSize) * progress) : OYUtils.FontSize(option.kTitleSelectFontSize! - (option.kTitleSelectFontSize! - option.kTitleFontSize) * progress)
            targetLab.font = OYUtils.BoldFontSize (option.kTitleSelectFontSize! + (option.kTitleSelectFontSize! - option.kTitleFontSize)  * progress)
            setupLabelsLayout()
        }
...
extension ZJPageTitleView {
    ...
    @objc fileprivate func titleLabelClick(tapGesture : UITapGestureRecognizer) {
        ...
        // 修改字体大小
        if option.kTitleSelectFontSize != nil{
            currentLab?.font = OYUtils.BoldFontSize (option.kTitleSelectFontSize!)
            oldLab.font = option.kIsNormalFontBold ? OYUtils.BoldFontSize(option.kTitleFontSize) : OYUtils.FontSize(option.kTitleFontSize)
            setupLabelsLayout()
        }
