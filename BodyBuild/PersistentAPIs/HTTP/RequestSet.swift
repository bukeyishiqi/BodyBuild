...
//    
    ...
    init(method: RequestType = .Get, url: String, _ params: [String: Any]? = nil, _ headers: Headers? = nil) {
        self.url = url
    ...
    var uploadProgress: UploadProgress = {_,_,_  in}
    var downloadProgress: DownloadProgress = {_,_,_  in }
