...
extension UITableView {
    ...
    func  op_insertSections(_ sections: IndexSet, with animation: UITableView.RowAnimation) {
        
    }
    
    func op_deleteSections(_ sections: IndexSet, with animation: UITableView.RowAnimation) {
        
    }
    
    func op_reloadSections(_ sections: IndexSet, with animation: UITableView.RowAnimation) {
    ...
    func op_insertRows(at indexPaths: [IndexPath], with animation: UITableView.RowAnimation) {
        
    }
    
    func op_deleteRows(at indexPaths: [IndexPath], with animation: UITableView.RowAnimation) {
        
    }
    
    func op_reloadRows(at indexPaths: [IndexPath], with animation: UITableView.RowAnimation) {
